...
export const FloatingNavBar: React.FC<FloatingNavBarProps> = ({ current, onChange }) => {
  ...
  const navItems: NavItemConfig[] = [
    ...
    { id: 'go-stock', label: '行情资讯', icon: TrendingUp },
    { id: 'dsa', label: 'DSA分析', icon: BarChart3 },
  ...
  const groupedNavItems: NavItemConfig[][] = [
    ...
    navItems.filter((item) => ['model-training', 'model-registry', 'research', 'trading', 'rss-news', 'alpha-research', 'trading-agents', 'daily-analysis', 'go-stock', 'dsa', 'data-dashboard'].includes(item.id)),
