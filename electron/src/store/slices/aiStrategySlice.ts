...
export type DashboardTab = 'dashboard' | 'strategy' | 'backtest' | 'trading' | 'profile' | 'agent' | 'ai-ide' | 'admin' | 'model-training' | 'model-registry' | 'research' | 'rss-news' | 'alpha-research' | 'trading-agents';
